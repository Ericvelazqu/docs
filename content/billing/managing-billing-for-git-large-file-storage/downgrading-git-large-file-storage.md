...
---
When you downgrade your number of data packs, your change takes effect on your next billing date. If you remove all your data packs, they will go back to the free defaults (1 GB each of bandwidth and storage).  If you're over 150% of the capacity of either bandwidth or storage, access to LFS and the data will be disabled. For more information, see "[About billing for {% data variables.large_files.product_name_long %}](/articles/about-billing-for-git-large-file-storage)."
